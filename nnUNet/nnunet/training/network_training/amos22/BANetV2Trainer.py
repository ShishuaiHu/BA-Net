# -*- coding:utf-8 -*-
from nnunet.training.network_training.amos22.nnUNetTrainerV2_4Fold import nnUNetTrainerV2_4Fold
from nnunet.training.data_augmentation.bdr_augmentation import get_BDR_augmentation
from nnunet.network_architecture.amos22.generic_BANetV2 import generic_BANetV2
...
class BANetV2Trainer(nnUNetTrainerV2_4Fold):
